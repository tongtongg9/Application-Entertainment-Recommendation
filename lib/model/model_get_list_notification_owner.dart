class BkNotificationforOwner {
  bool ok;
  List<Rsnotibookbyow> rsnotibookbyow;

  BkNotificationforOwner({this.ok, this.rsnotibookbyow});

  BkNotificationforOwner.fromJson(Map<String, dynamic> json) {
    ok = json['ok'];
    if (json['rsnotibookbyow'] != null) {
      rsnotibookbyow = new List<Rsnotibookbyow>();
      json['rsnotibookbyow'].forEach((v) {
        rsnotibookbyow.add(new Rsnotibookbyow.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ok'] = this.ok;
    if (this.rsnotibookbyow != null) {
      data['rsnotibookbyow'] =
          this.rsnotibookbyow.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class Rsnotibookbyow {
  int bkId;
  int npId;
  int userId;
  int bkSeat;
  ...
  Rsnotibookbyow.fromJson(Map<String, dynamic> json) {
    bkId = json['bk_id'];
    npId = json['np_id'];
    userId = json['user_id'];
    bkSeat = json['bk_seat'];
